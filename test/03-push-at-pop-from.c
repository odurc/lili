...
int main(void)
{
    ...
    assert(test_nodes(list, (int []){0, 1, 2, 3, 4}));

    int more_data[] = {10, 20, 30, 40, 50, 60};

    lili_push_at(list, &more_data[0], 4);
    assert(test_nodes(list, (int []){0, 1, 2, 3, 10, 4}));

    lili_push_at(list, &more_data[1], 25);
    assert(test_nodes(list, (int []){0, 1, 2, 3, 10, 4, 20}));

    lili_push_at(list, &more_data[2], 2);
    assert(test_nodes(list, (int []){0, 1, 30, 2, 3, 10, 4, 20}));

    lili_push_at(list, &more_data[3], -2);
    assert(test_nodes(list, (int []){0, 1, 30, 2, 3, 10, 4, 40, 20}));

    lili_push_at(list, &more_data[4], -23);
    assert(test_nodes(list, (int []){50, 0, 1, 30, 2, 3, 10, 4, 40, 20}));
    ...
    assert(test_nodes(list, (int []){0, 1, 30, 2, 3, 10, 4, 40}));

    lili_pop_from(list, 100);
    assert(test_nodes(list, (int []){0, 1, 30, 2, 3, 10, 4}));

    lili_pop_from(list, -50);
    assert(test_nodes(list, (int []){1, 30, 2, 3, 10, 4}));

    lili_pop_from(list, 4);
    assert(test_nodes(list, (int []){1, 30, 2, 3, 4}));

    lili_pop_from(list, -3);
    assert(test_nodes(list, (int []){1, 30, 3, 4}));
